...
import com.edu.news.Adapter.SavePostAdapter;
...
public class saveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        savePostRV  = fragmentView.findViewById(R.id.postRV);
        savePostRV.setLayoutManager(new LinearLayoutManager(getActivity()));
        savePostRV.setHasFixedSize(true);
        firebaseDatabase = FirebaseDatabase.getInstance();
        dbSave = firebaseDatabase.getReference("Favorites");
        return fragmentView;
    }
    ...
    public void onStart() {
        ...
        dbSave.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot savePostSnap: dataSnapshot.getChildren()) {

                    SavePost savePost = savePostSnap.getValue(SavePost.class);
                    savePostList.add(savePost) ;

                }

                savePostAdapter = new SavePostAdapter(getActivity(), savePostList);
                savePostRV.setAdapter(savePostAdapter);
